...
#[derive(Debug)]
pub struct LuaEngineProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LuaEngineProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LuaEngine processing");
    
    let mut processor = LuaEngineProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LuaEngineProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LuaEngineProcessor::new(false);
